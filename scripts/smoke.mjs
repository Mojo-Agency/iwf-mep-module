...
check('count text', $('#mep-module .mep-status').textContent === `${PAGE} out of ${total} representatives shown`, $('#mep-module .mep-status').textContent);
...
check('filter resets to page 1 and announces total', $('#mep-module .mep-sr-only[aria-live]') !== null);
